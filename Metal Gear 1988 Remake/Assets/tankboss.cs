...
public class tankboss : MonoBehaviour
{
    ...
    public static int enemyhealth = 600;
    ...
    public static FMOD.Studio.EventInstance ropeSound;
    public GameObject tankbosstalk;
    void Start()
    {
        ropeSound = FMODUnity.RuntimeManager.CreateInstance("event:/gearSoundEffect");
    ...
    void Update()
    {
        ...
        if (zamanlama2 > 8)
        {
            ...
            if (biryer == 1)
            {
                end.position = new Vector3(2.5f, 1.8f, 0);
                
                if (ýþýnlanmazamaný > 0.5f && ýþýnlanmazamaný <= 0.51f)
                {
                    ipgörünürlük.SetActive(true);
                    //ipses.Play();
                    ropeSound.start();
                }
                ...
                if (ýþýnlanmazamaný > 2.5f)
                {
                    ipegitme = false;
                    ipgörünürlük.SetActive(false);
            ...
            {
                end.position = new Vector3(-7f, 1.8f, 0);
            ...
            {
                end.position = new Vector3(-5.5f, -3f, 0);
            ...
            {
                end.position = new Vector3(6.2f, -3f, 0);
    ...
    //public AudioSource ipses;

    public Transform end;
    public GameObject ipgörünürlük;
    bool ipegitme;
